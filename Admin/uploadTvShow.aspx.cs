...
{
    public partial class uploadTvShow : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string insert_q = "INSERT INTO tvShows (title,category,director,actors,producer,watchTime,releaseDate,poster,videoLink) VALUES (@title,@category,@director,@actors,@producer,@watchTime,@releaseDate,@poster,@videoLink)";
