...
{
    public partial class tvShowsList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string select_q = "SELECT * FROM tvShows ORDER BY category";
                    ...
                    while (dr.Read())
                    {
                        ...
                        btnEdit.Text = "EDIT";
                        btnEdit.ID = "btnEdit";
                        btnEdit.PostBackUrl = "editTvShow.aspx?id=" + dr["id"].ToString();
                        ...
                        btnDelete.PostBackUrl = "deleteTvShow.aspx?id=" + dr["id"].ToString();
