...
namespace Netflix_clone
{
    public partial class movies : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            showMovies_onlyOnNetflix();
            showMovies_trending();
            showMovies_romance();
            showMovies_sciFi();
            showMovies_thriller();
            showMovies_adventure();
            showMovies_comedy();
        }

        protected void showMovies_onlyOnNetflix()
        {
        ...
        protected void showMovies_trending()
        {
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Asp.Net   Project\Netflix-clone\App_Data\mainDb.mdf;Integrated Security=True");
            try
            {
                ...
                string select_q = "SELECT * FROM movies";
                SqlCommand cmd = new SqlCommand(select_q, conn);
                SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void showMovies_romance()
        {
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Asp.Net   Project\Netflix-clone\App_Data\mainDb.mdf;Integrated Security=True");
            try
            {
        ...
        protected void showMovies_sciFi()
        {
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Asp.Net   Project\Netflix-clone\App_Data\mainDb.mdf;Integrated Security=True");
            try
            {
                ...
                string select_q = "SELECT * FROM movies WHERE category='Sci-Fi'";
                SqlCommand cmd = new SqlCommand(select_q, conn);
                SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void showMovies_thriller()
        {
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Asp.Net   Project\Netflix-clone\App_Data\mainDb.mdf;Integrated Security=True");
            try
            {
                ...
                string select_q = "SELECT * FROM movies WHERE category='Thriller'";
                SqlCommand cmd = new SqlCommand(select_q, conn);
                SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void showMovies_adventure()
        {
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Asp.Net   Project\Netflix-clone\App_Data\mainDb.mdf;Integrated Security=True");
            try
            {
                ...
                string select_q = "SELECT * FROM movies WHERE category='Adventure'";
                SqlCommand cmd = new SqlCommand(select_q, conn);
                SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void showMovies_comedy()
        {
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Asp.Net   Project\Netflix-clone\App_Data\mainDb.mdf;Integrated Security=True");
            try
            {
                ...
                string select_q = "SELECT * FROM movies WHERE category='comedy'";
                SqlCommand cmd = new SqlCommand(select_q, conn);
                SqlDataReader dr = cmd.ExecuteReader();
